...
static_assert(Site<PointSite<Point2D>, Point2D, EuclideanDistance<Point2D>>);
static_assert(Site<PointSite<Point3D>, Point3D, EuclideanDistance<Point3D>>);
static_assert(Site<PointSite<PointXD>, PointXD, EuclideanDistance<PointXD>>);

TEST(PointSiteEuclideanDistanceTest, Point2DTest) {
    const PointSite<Point2D> site(Point2D{1, 2});
    const Point2D point{3, 4};
    const EuclideanDistance<Point2D> func;
...
TEST(PointSiteEuclideanDistanceTest, Point3DTest) {
    ...
    const EuclideanDistance<Point3D> func;
...
TEST(PointSiteEuclideanDistanceTest, PointXDTest) {
    ...
    const EuclideanDistance<PointXD> func;
